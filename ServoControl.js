...
function updateDuty() {
    ...
    if (stdin[0] != 0 && stdin[1] != 0 ){
        leftEyePos = leftMax;
        rightEyePos = rightMin;
    } 
    else{
        leftEyePos = leftMin;
        rightEyePos = rightMax;
    }
    ...
    var leftDuty_cycle = (rightEyePos * 0.115) + duty_min;
    b.analogWrite(rightEyebrow, rightDuty_cycle, 60);
    console.log("duty_cycle: " + rightDuty_cycle);
